...
def recommend_portfolio(intent_request):
    ...
    risk_recommendation = get_recommendation(risk_level)
    ...
    return close(
        ...
        "Fulfilled",
        {
            ...
            "content": """Thank you, {}, for your information.  At age {},
            ${} dollars has been invested at the recommended risk: {}.
            """.format(
                first_name, age, investment_amount, risk_recommendation
            ),
        },
    )
